...
public class Bot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (message != null && message.hasText()) {
            switch (message.getText()) {
                case "/start":
                    sendMsg(message, "/help для дополнительной информации шо");
                    break;
                case "/help":
                    sendMsg(message, "Прогноз погоды: /weather");
                    break;
                case "/settings":
    ...
    public String getBotUsername() {
        return "FirstWeatherBot";
    }

    @Override
    public String getBotToken() {
        return "1524911835:AAGYS1YaSfW8-iCQKtcU3HseNTPNuYuUYe8";
    }
}
